...
// Fetch product data directly using the string slug value
...
// Next.js components require awaiting params if they contain dynamic routes
export default async function ProductPage({ params }) {
  // Await the params Promise to unlock the slug safely
